# R Project Template
cat("Boston House Prices Regression Problem\n")
cat("======================================\n")
...
# c) Split-out validation dataset
     set.seed(seed)
     createDataPartition(BostonHousing$medv, p=0.8, list=FALSE) -> validationIndex
     BostonHousing[-validationIndex,] -> validation
     BostonHousing[validationIndex,] -> training
